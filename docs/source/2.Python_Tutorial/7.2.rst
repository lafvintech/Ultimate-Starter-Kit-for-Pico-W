...
#. Switch the path to the folder where you downloaded the `code package <https://github.com/lafvintech/Ultimate-Starter-Kit-for-Pico-W/archive/refs/heads/main.zip>`_ before and open the ``2_cheer_light.py`` file under the path of ``Ultimate-Starter-Kit-for-Pico-W/Python/iot``.
