...
.. note::
    ...
    * Open the ``4.web_page.py`` file under the path of ``Ultimate-Starter-Kit-for-Pico-W\Python\1.Project\iot`` or copy this code into Thonny, then click "Run Current Script" or simply press F5 to run it.
...
Phenomenon
^^^^^^^^^^^
.. image:: img/5.phenomenon/7.4.png
    :width: 100%